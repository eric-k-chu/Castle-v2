...
import { ErrorMsg, Loading } from "@/_components";
...
async function getPlayerInfo(username: string) {
  const apiCalls = [
    ...
    getPlayerData(`player/${username}/stats`),
    getPlayerData(`player/${username}/games/archives`),
    getPlayerData(`player/${username}/tournaments`),
  ];
