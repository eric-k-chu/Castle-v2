  ...
  return (
    ...
    >
      <div className="relative h-[150px] max-h-[150px] min-h-[150px] w-full">
        ...
        />
        <div className="absolute bottom-0 flex h-full w-full items-center justify-center rounded-t-lg bg-neutral-900/60 opacity-0 transition-opacity duration-150 ease-in-out group-hover:opacity-100 sm:text-sm md:text-base lg:text-lg">
